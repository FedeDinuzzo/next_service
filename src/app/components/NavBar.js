                ...
                <ul>
                  <li className='flex w-[100vw] justify-evenly'>
                    <Link href={`/`} aria-label="Ir a la sección de inicio">
                      <Image src={navInicio} height="28px" width="28px" alt={"navegacion inicio"} priority className={`navLink mt-[2px] w-[28px] h-[auto] text-center cursor-pointer`} />
                    </Link>
                    <Link href={`/heladeras`} aria-label="Ir a la sección de heladeras">
                      <Image src={navHeladera} height="18px" width="18px" alt={"navegacion heladeras"} priority className={`navLink w-[18px] h-[auto] mr-20 text-center cursor-pointer`} />
                    </Link>
                    <Link href={`/lavarropas`} aria-label="Ir a la sección de lavarropas">
                      <Image src={navLavarropas} height="23px" width="23px" alt={"navegacion lavarropas"} priority className={`navLink mt-[2px] w-[23px] h-[auto] text-center cursor-pointer`} />
                    </Link>
                    <Link href={`/contacto`} aria-label="Ir a la sección de contacto">
                      <Image src={navContacto} height="20px" width="20px" alt={"navegacion contacto"} priority className={`navLink mt-[3px] w-[20px] h-[auto] text-center cursor-pointer`} />
                    </Link>
                  </li>
                </ul>
            </div>
